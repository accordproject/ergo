...
require('yargs')
    .command('compile', 'compile Jura to JavaScript', (yargs) => {
        ...
        return Commands.compile(argv.jura,argv.contractname,argv.clausename)
            .then((result) => {
                console.log(result);
            })
            .catch((err) => {
    ...
    .command('execute', 'execute a contract clause', (yargs) => {
        ...
        return Commands.execute(argv.jura, argv.clause, argv.request, argv.contractname, argv.clausename)
            .then((result) => {
