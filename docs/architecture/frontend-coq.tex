\begin{tikzpicture}[
 ...
 \node[lang, hyperlink node=\coqurl{Ergo.Lang}{Ergo}{run_nraenv_optims},
       right=of ergoast]
      (naming) {Namespace\\Resolution};

 \node[lang, coqc, hyperlink node=\coqurl{Common.CTO}{CTO}{cto_type},
       above=3em of naming] (cto_type) {CTO\\ Types};

 \node[lang, source,
       right=1.875em of ergo] (cto) {CTO};

 % AST
 \node[lang, coqc, hyperlink node=\coqurl{Ergo.Lang}{Ergo}{ergo_package},
       right=of naming]
      (ergoastresolved) {Ergo\\Syntax Tree};
 ...
 \path[trans] (cto.south) -- (cto_type.north);
