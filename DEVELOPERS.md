...
This document describes how to set up your development environment to build and test Ergo, and
explains the basic mechanics of using `git`, `node`, `lerna`.

### Installing Dependencies

Before you can build Ergo, you must install and configure the following dependencies on your
machine:
...
To contribute code to Ergo, you must have a GitHub account so you can push code to your own
fork of Ergo and open Pull Requests in the [GitHub Repository][github].

To create a Github account, follow the instructions [here](https://github.com/signup/free).
Afterwards, go ahead and [fork](http://help.github.com/forking) the
[main Ergo repository][github].
...
we use the git commit messages to **generate the Ergo change log**.
...
The Ergo project uses [jsdoc](http://usejsdoc.org/) for all of its code
documentation.
...
version-specific documentation by simply checking out a version of Ergo and running the build.
