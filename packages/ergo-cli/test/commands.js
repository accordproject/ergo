...
describe('ergo', () => {
    ...
    describe('#executehello', function () {
        it('should execute a request to a smart Ergo contract', async function () {
            ...
            const contractPath = { file: Path.resolve(__dirname, 'data/helloworld', 'contract.json') };
            const requestPath = { file: Path.resolve(__dirname, 'data/helloworld', 'request.json') };
            const statePath = { file: Path.resolve(__dirname, 'data/helloworld', 'state.json') };
    ...
    describe('#executehellostate', function () {
        it('should execute a smart Ergo contract with state once', async function () {
            ...
            const contractPath = { file: Path.resolve(__dirname, 'data/helloworldstate', 'contract.json') };
            const requestPath = { file: Path.resolve(__dirname, 'data/helloworldstate', 'request.json') };
            const statePath = { file: Path.resolve(__dirname, 'data/helloworldstate', 'state.json') };
    ...
    describe('#executeinstallmentsale', function () {
        it('should initialize a smart Ergo contract state', async function () {
            ...
            const contractPath = { file: Path.resolve(__dirname, 'data/installment-sale', 'contract.json') };
        ...
        it('should initialize a smart Ergo contract and execute one request', async function () {
            ...
            const ctoPath = Path.resolve(__dirname, 'data/installment-sale', 'model.cto');
            const contractPath = { file: Path.resolve(__dirname, 'data/installment-sale', 'contract.json') };
            const requestPath = { file: Path.resolve(__dirname, 'data/installment-sale', 'request.json') };
    ...
    describe('#executepromissorynote', function () {
        it('should execute a smart Ergo contract', async function () {
            ...
            const contractPath = { file: Path.resolve(__dirname, 'data/promissory-note', 'contract.json')};
            const requestPath = { file: Path.resolve(__dirname, 'data/promissory-note', 'request.json') };
            const statePath = { file: Path.resolve(__dirname, 'data/promissory-note', 'state.json') };
    ...
    describe('#executeacceptanceofdelivery', function () {
        it('should execute a smart Ergo contract', async function () {
            ...
            const contractPath = { file: Path.resolve(__dirname, 'data/acceptance-of-delivery', 'contract.json') };
            const requestPath = { file: Path.resolve(__dirname, 'data/acceptance-of-delivery', 'request.json') };
            const statePath = { file: Path.resolve(__dirname, 'data/acceptance-of-delivery', 'state.json') };
    ...
    describe('#invokehelloworld', function () {
        it('should invoke a clause in a smart Ergo contract', async function () {
            ...
            const ctoPath = Path.resolve(__dirname, 'data/helloworld', 'model.cto');
            const contractPath = { file: Path.resolve(__dirname, 'data/helloworld', 'contract.json') };
            const paramsPath = { file: Path.resolve(__dirname, 'data/helloworld', 'params.json') };
            const statePath = { file: Path.resolve(__dirname, 'data/helloworld', 'state.json') };
    ...
    describe('#initinstallmentsale', function () {
        it('should invoke init', async function () {
            ...
            const ctoPath = Path.resolve(__dirname, 'data/installment-sale', 'model.cto');
            const contractPath = { file: Path.resolve(__dirname, 'data/installment-sale', 'contract.json') };
            const paramsPath = { file: Path.resolve(__dirname, 'data/installment-sale', 'params.json') };
