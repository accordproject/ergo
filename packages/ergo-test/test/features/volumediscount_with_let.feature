Feature: Volume discount (with let)
  ...
  Background:
    Given the model in file "examples/volumediscount/model.cto"
    And the Ergo contract "org.accordproject.volumediscount.VolumeDiscount" in file "examples/volumediscount/logic2.ergo"
