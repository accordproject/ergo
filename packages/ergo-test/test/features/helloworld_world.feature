Feature: Betty Buyer's Hello World
  ...
  Background:
    Given the Ergo contract "org.accordproject.helloworld.HelloWorld" in file "examples/helloworld2/logic/logic2.ergo"
    Given the model in file "examples/helloworld2/model/model.cto"
