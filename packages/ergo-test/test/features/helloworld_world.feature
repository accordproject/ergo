Feature: Betty Buyer's Hello World
  ...
  Background:
    Given the Ergo contract "org.accordproject.helloworld.HelloWorld" in file "examples/helloworld1/logic/logic1.ergo"
    Given the model in file "examples/helloworld1/model/model.cto"
