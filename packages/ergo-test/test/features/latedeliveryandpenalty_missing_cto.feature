Feature: Late delivery contract
  ...
  Background:
    Given the Ergo contract "org.accordproject.latedeliveryandpenalty.LateDeliveryAndPenalty" in file "examples/latedeliveryandpenalty/logic/logic.ergo"
    And the model in file "examples/latedeliveryandpenalty/model/model2.cto"
...
"""
Namespace is not defined for type org.accordproject.test.* File 'examples/latedeliveryandpenalty/model/model2.cto': 
"""
