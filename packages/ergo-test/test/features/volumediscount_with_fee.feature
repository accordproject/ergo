Feature: Volume discount (with fee)
  ...
  Background:
    Given the model in file "../../../tests/volumediscount3/model/model.cto"
    And the Ergo contract "org.accordproject.volumediscount.VolumeDiscount" in file "../../../tests/volumediscount3/logic/logic3.ergo"
