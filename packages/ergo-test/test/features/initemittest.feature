Feature: Init emit test
  ...
  Background:
    Given the Ergo contract "org.accordproject.initemittest.InitEmitTest" in file "examples/initemittest/logic.ergo"
    And the model in file "examples/initemittest/model.cto"
