Feature: Shadowing test
  ...
  Background:
    Given the Ergo contract "org.accordproject.shadowingtest.ShadowingTest" in file "examples/shadowingtest/logic.ergo"
    And the model in file "examples/shadowingtest/model.cto"
