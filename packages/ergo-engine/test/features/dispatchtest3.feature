Feature: Dispatch Tests
  ...
  Background:
    Given the Ergo contract "org.accordproject.dispatchtest.DispatchTest" in file "examples/dispatchtest/logic3.ergo"
    And the model in file "examples/dispatchtest/model.cto"
