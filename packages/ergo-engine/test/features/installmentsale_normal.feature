Feature: Installment sale Contract
  ...
  Background:
    Given the Ergo contract "org.accordproject.installmentsale.InstallmentSale" in file "examples/installment-sale/logic.ergo"
    And the model in file "examples/installment-sale/model.cto"
