Feature: Shadowing test
  ...
  Background:
    Given the Ergo contract "org.accordproject.shadowingtest.ShadowingTest" in file "data/shadowingtest/logic.ergo"
    And the model in file "data/shadowingtest/model.cto"
