Feature: Promissory note Contract
  ...
  Background:
    Given the Ergo contract "org.accordproject.promissorynote.PromissoryNote" in file "data/promissory-note/logic3.ergo"
    And the Ergo logic in file "data/promissory-note/money.ergo"
    And the model in file "data/promissory-note/business.cto"
    And the model in file "data/promissory-note/model.cto"
