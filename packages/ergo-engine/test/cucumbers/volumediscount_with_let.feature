Feature: Volume discount (with let)
  ...
  Background:
    Given the model in file "data/volumediscount/model.cto"
    And the Ergo contract "org.accordproject.volumediscount.VolumeDiscount" in file "data/volumediscount/logic2.ergo"
