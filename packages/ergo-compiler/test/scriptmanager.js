...
describe('ScriptManager', () => {
    ...
    describe('#constructor', () => {
        ...
        it('should support both JavaScript and Ergo scripts', async function() {
            ...
            scriptManager.getCompiledScript().getContents().length.should.equal(35851);
            scriptManager.getCompiledJavaScript().length.should.equal(35851);
        ...
        it('should compile Ergo scripts', async function() {
            ...
            scriptManager.addScript(script1);
            scriptManager.addScript(script2);
            scriptManager.compileLogic().getContents().length.should.equal(35851);
            scriptManager.getCompiledScript().getContents().length.should.equal(35851);
