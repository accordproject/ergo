...
describe('JSONGenerator', () => {
    ...
    describe('#convertToJSON', () => {
        ...
        it('should pass through an integer object', () => {
            jsonGenerator.convertToJSON({ getType: () => { return 'Integer'; } }, 123456).nat.should.equal(123456);
        });
        ...
        it('should pass through a long object', () => {
            jsonGenerator.convertToJSON({ getType: () => { return 'Long'; } }, 1234567890).nat.should.equal(1234567890);
        });
        ...
        it('should convert a date time object to ISOString', () => {
            ...
            jsonGenerator.convertToJSON({ getType: () => { return 'DateTime'; } }, date).format('YYYY-MM-DDTHH:mm:ss.SSS[Z]').should.equal('1995-08-09T00:00:00.000Z');
        });
        it('should convert a date time object to ISOString in a different timezone', () => {
            ...
            jsonGenerator.convertToJSON({ getType: () => { return 'DateTime'; } }, date).format('YYYY-MM-DDTHH:mm:ss.SSSZ').should.equal('1995-08-09T00:00:00.000-05:00');
        });
    ...
    describe('#visitRelationshipDeclaration', () => {
        ...
        it('should generate a circular resource if option is specified', () => {
            ...
            result.should.deep.equal({'$class':'org.acme.SimpleAssetCircle','assetId':'DOGE_1','next':{'$class':'org.acme.SimpleAssetCircle','assetId':'DOGE_2','next':{'$class':'org.acme.SimpleAssetCircle','assetId':'DOGE_3','next':'DOGE_1'}}});
        });
        ...
        it('should generate an array of relationships', () => {
            ...
            result.should.deep.equal(['DOGE_1', 'DOGE_2']);
        });
    ...
    describe('#getRelationshipText', () => {
        ...
        it('should return a relationship string for a relationship', () => {
            let relationship = factory.newRelationship('org.acme', 'MyAsset1', 'DOGE_1');
            jsonGenerator.getRelationshipText(relationshipDeclaration1, relationship).should.equal('DOGE_1');
        });
        ...
        it('should return a relationship string for a resource if permitted', () => {
            ...
            let resource = factory.newResource('org.acme', 'MyAsset1', 'DOGE_1');
            jsonGenerator.getRelationshipText(relationshipDeclaration1, resource).should.equal('DOGE_1');
        });
    ...
    describe('#visitField', () => {
        ...
        it('should populate if a primitive integer', () => {
            ...
            parameters.stack.push(primitive);
            should.equal(jsonGenerator.visitField(field, parameters).nat, 2);
        });
        ...
        it('should populate if a primitive Long', () => {
            ...
            parameters.stack.push(primitive);
            should.equal(jsonGenerator.visitField(field, parameters).nat, 1234567890);
        });
        ...
        it('should populate an array if array contains a Enums', () => {
            ...
            let result = jsonGenerator.visitField(field,parameters);
            result.should.deep.equal([{'nat':0}, {'nat':2}, {'nat':1}]);
        });
