...
/**
 * Exception throws when an ergo file does not type check
 * @extends CompilerException
 * @see See  {@link CompilerException}
 * @class
 * @memberof module:ergo-compiler
 * @private
 */
class TypeException extends CompilerException {

    /**
     * Create a TypeException
