...
Section Ergo.
  Section Ast.
    ...
    | EConst : A -> data -> ergo_expr (**r constant *)
    ...
    | EUnaryBuiltin : A -> QcertOps.Unary.op -> ergo_expr -> ergo_expr (**r unary builtin *)
    | EBinaryBuiltin : A -> QcertOps.Binary.op -> ergo_expr -> ergo_expr -> ergo_expr (**r binary builtin *)
