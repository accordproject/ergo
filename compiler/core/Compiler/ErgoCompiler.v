...
Module ErgoCompiler.
  ...
  Module ErgoData := QLib.QcertData.
  Module ErgoOps := QLib.QcertOps.
  Module ErgoCType := QLib.QcertType.

  (** Utils *)
  (* XXX Exposed so it can be called from JavaScript - Should be removed once we switch to the REPL *)
  Definition javascript_identifier_sanitizer := QLib.QcertCodeGen.javascript_identifier_sanitizer.
