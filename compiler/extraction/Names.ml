...
let accordproject_base_namespace =
  'o'::('r'::('g'::('.'::('a'::('c'::('c'::('o'::('r'::('d'::('p'::('r'::('o'::('j'::('e'::('c'::('t'::('.'::('b'::('a'::('s'::('e'::[])))))))))))))))))))))

(** val accordproject_runtime_namespace : char list **)

let accordproject_runtime_namespace =
  'o'::('r'::('g'::('.'::('a'::('c'::('c'::('o'::('r'::('d'::('p'::('r'::('o'::('j'::('e'::('c'::('t'::('.'::('c'::('i'::('c'::('e'::('r'::('o'::('.'::('r'::('u'::('n'::('t'::('i'::('m'::('e'::[])))))))))))))))))))))))))))))))

(** val accordproject_contract_namespace : char list **)

let accordproject_contract_namespace =
  'o'::('r'::('g'::('.'::('a'::('c'::('c'::('o'::('r'::('d'::('p'::('r'::('o'::('j'::('e'::('c'::('t'::('.'::('c'::('i'::('c'::('e'::('r'::('o'::('.'::('c'::('o'::('n'::('t'::('r'::('a'::('c'::('t'::[]))))))))))))))))))))))))))))))))
...
let default_enum_absolute_name =
  absolute_name_of_local_name accordproject_base_namespace
    ('E'::('n'::('u'::('m'::[]))))
...
let default_error_absolute_name =
  absolute_name_of_local_name accordproject_stdlib_namespace
    ('E'::('r'::('g'::('o'::('E'::('r'::('r'::('o'::('r'::('R'::('e'::('s'::('p'::('o'::('n'::('s'::('e'::[])))))))))))))))))
