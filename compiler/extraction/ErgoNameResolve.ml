...
let stdlib_imports =
  accordproject_base_namespace :: (accordproject_stdlib_namespace :: (accordproject_time_namespace :: (accordproject_options_namespace :: (accordproject_template_namespace :: []))))
...
let patch_cto_imports ctxt_ns decls =
  ...
  then (DImport (dummy_provenance, (ImportSelf (dummy_provenance,
         ...
         accordproject_base_namespace)))) :: ((DImport (dummy_provenance,
...
let new_ergo_module_namespace ctxt ns =
  ...
  then esuccess ctxt []
         ...
         (dummy_provenance, accordproject_base_namespace)))) :: ((DImport
