...
let wrap_template_variable prov name ve =
  let varparam =
    ErgoCompiler.econst prov
      (ErgoCompiler.ErgoData.dstring (char_list_of_string name))
  in
  ErgoCompiler.ecallfun
    prov
...
let make_template_ulist prov name ve =
  ...
  let listContent =
    ErgoCompiler.ebinarybuiltin prov
      ...
      (ErgoCompiler.econst prov (ErgoCompiler.ErgoData.dstring (char_list_of_string "")))
      (ErgoCompiler.eforeach prov fl None
         (ErgoCompiler.etext prov
            (ErgoCompiler.econst prov (ErgoCompiler.ErgoData.dstring (char_list_of_string bullet)) :: ve)))
  in
  ErgoCompiler.ecallfun
    prov
...
let make_template_if prov name ve1 =
  let ve2 = [ErgoCompiler.econst prov (ErgoCompiler.ErgoData.dstring (char_list_of_string ""))] in
...
| v = IDENT AS s = STRING
    { let prov = mk_provenance $startpos $endpos in
      ...
      wrap_template_variable_as prov v ve
        (ErgoCompiler.econst prov (ErgoCompiler.ErgoData.dstring (char_list_of_string s))) }
| v = IDENT
    { let prov = mk_provenance $startpos $endpos in
