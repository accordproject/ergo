...
Section CTO.
  ...
  | CTOAsset : option string -> list (string * cto_type) -> cto_declaration_kind
  | CTOParticipant : option string -> list (string * cto_type) -> cto_declaration_kind
    ...
    Definition resolve_decl_kind (namespace:string) (tbl:cto_names_table)
      ...
      | CTOEvent extend_name cto_struct =>
        elift2 CTOEvent
               (resolve_extend_name namespace tbl extend_name)
               (resolve_cto_struct namespace tbl cto_struct)
      | CTOAsset extend_name cto_struct =>
        elift2 CTOAsset
               (resolve_extend_name namespace tbl extend_name)
               (resolve_cto_struct namespace tbl cto_struct)
      | CTOParticipant extend_name cto_struct =>
