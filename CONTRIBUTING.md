...
We'd love for you to contribute to our source code and to make Ergo even better than it is
...
* In GitHub, send a pull request to `ergo:master`. This will trigger the check of the
